...
const regressionCases: AssessmentCase[] = [
  ...
  { description: "multiline command", source: "set -e\nrm obsolete.txt", kind: "deletion", policy: "direct-rm" },
  ...
  { description: "function definition and invocation", source: "delete_generated_files() { rm obsolete.txt; }\ndelete_generated_files", kind: "deletion", policy: "direct-rm" },
  ...
  { description: "shred dash operand", source: "shred -- -u", kind: "safe" },
  { description: "git clean force dry run", source: "git clean -f -n", kind: "safe" },
  { description: "git clean help", source: "git clean --help", kind: "safe" },
  { description: "git rm help", source: "git rm --help file", kind: "safe" },
